...
# post-lock negative residual carrier drift.
# Usage:
#   vivado -mode batch -source scripts/run_qpsk_rx_demod_random_external_drift_neg_sim.tcl
...
set_property verilog_define {QPSK_RX_RANDOM_DRIFT_NEG=1} [get_filesets sim_1]
...
puts "INFO: RX demod random-external negative carrier-drift simulation completed."
