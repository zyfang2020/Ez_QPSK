...
# wider positive residual carrier offset in batch mode.
# Usage:
#   vivado -mode batch -source scripts/run_qpsk_rx_demod_random_external_wide_sim.tcl
...
set_property verilog_define {QPSK_RX_RANDOM_WIDE=1} [get_filesets sim_1]
...
puts "INFO: RX demod random-external wide positive-offset simulation completed."
