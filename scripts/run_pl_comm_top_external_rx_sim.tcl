#!/usr/bin/env tclsh
# Run behavioral simulation for tb_pl_comm_top_external_rx in batch mode.
# Usage:
#   vivado -mode batch -source scripts/run_pl_comm_top_external_rx_sim.tcl
...
puts "INFO: top-level external RX simulation completed."
