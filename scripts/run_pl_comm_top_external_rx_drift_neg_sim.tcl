...
# Usage:
#   vivado -mode batch -source scripts/run_pl_comm_top_external_rx_drift_neg_sim.tcl
...
set_property verilog_define {QPSK_TOP_EXT_RX_DRIFT_NEG=1} [get_filesets sim_1]
...
puts "INFO: top-level external RX negative drift simulation completed."
