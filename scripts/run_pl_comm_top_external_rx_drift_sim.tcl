#!/usr/bin/env tclsh
# Run behavioral simulation for tb_pl_comm_top_external_rx with a positive
# post-lock residual carrier drift from +15 kHz to +35 kHz.
# Usage:
#   vivado -mode batch -source scripts/run_pl_comm_top_external_rx_drift_sim.tcl
...
set_property verilog_define {QPSK_TOP_EXT_RX_DRIFT=1} [get_filesets sim_1]
...
puts "INFO: top-level external RX positive drift simulation completed."
