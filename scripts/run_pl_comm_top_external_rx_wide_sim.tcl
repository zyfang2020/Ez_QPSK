#!/usr/bin/env tclsh
# Run behavioral simulation for tb_pl_comm_top_external_rx with a wider positive
# residual carrier offset in batch mode.
# Usage:
#   vivado -mode batch -source scripts/run_pl_comm_top_external_rx_wide_sim.tcl
...
set_property verilog_define {QPSK_TOP_EXT_RX_WIDE=1} [get_filesets sim_1]
...
puts "INFO: top-level external RX wide positive-offset simulation completed."
