...
# post-lock positive residual carrier drift.
# Usage:
#   vivado -mode batch -source scripts/run_qpsk_rx_demod_random_external_drift_sim.tcl
...
set_property verilog_define {QPSK_RX_RANDOM_DRIFT=1} [get_filesets sim_1]
...
puts "INFO: RX demod random-external carrier-drift simulation completed."
