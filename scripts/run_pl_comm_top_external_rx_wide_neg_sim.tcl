#!/usr/bin/env tclsh
# Run behavioral simulation for tb_pl_comm_top_external_rx with a wider negative
# residual carrier offset in batch mode.
# Usage:
#   vivado -mode batch -source scripts/run_pl_comm_top_external_rx_wide_neg_sim.tcl
...
set_property verilog_define {QPSK_TOP_EXT_RX_WIDE_NEG=1} [get_filesets sim_1]
...
puts "INFO: top-level external RX wide negative-offset simulation completed."
